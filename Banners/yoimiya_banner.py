...
def yoimiya_banner(limit):
    """
    Banner contains all standard 5 star characters, including promotional character 'Yoimiya'
    Contains all standard 4 star characters and weapons
    Characters 'Sayu','Diona' and 'Xinyan' have higher drop rate than the other ones
        ...
        # 10 - is 4 star pity (n-1) = 9
            ...
            # 4 Star
                ...
                if not pp.flag_4star:
                    ...
                    if random.randint(1, 2) == 1:
                        ...
                        b = random.choice(lstbn.yoimiya_banner_4)
                        # Adding to Inventory
            ...
            # 5 Star
                ...
                if not pp.flag_5star:
                    ...
                    if random.randint(1, 2) == 1:
                        # Promotional Character won
                        a = random.choice(lstbn.yoimiya_banner_5)
                        # Adding to Inventory
...
# Add to the list for
def add_gacha_yoimiya(rarity, item):
    global gacha
    global gacha_show
