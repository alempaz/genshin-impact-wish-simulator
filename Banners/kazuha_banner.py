...
def kazuha_banner(limit):
    """
    Banner contains all standard 5 star characters, including promotional character 'Kazuha'
    Contains all standard 4 star characters and weapons
    Characters 'Rosaria','Bennet' and 'Razor' have higher drop rate than the other ones
        ...
        # 10 - is 4 star pity (n-1) = 9
            ...
            # 4 Star
                ...
                if not pp.flag_4star:
                    ...
                    if random.randint(1, 2) == 1:
                        ...
                        b = random.choice(lstbn.kazuha_banner_4)
                        # Adding to Inventory
            ...
            # 5 Star
                ...
                if not pp.flag_5star:
                    ...
                    if random.randint(1, 2) == 1:
                        # Promotional Character won
                        a = random.choice(lstbn.kazuha_banner_5)
                        # Adding to Inventory
...
# Add to the list for
def add_gacha_kazuha(rarity, item):
    global gacha
    global gacha_show
