...
def banner(limit):
    """
    Banner contains all standard 5 star characters, including promotional character 'Albedo'
    Contains all standard 4 star characters and weapons
    Characters 'Rosaria','Bennet' and 'Noelle' have higher drop rate than the other ones
        ...
        # 10 - is 4 star pity (n-1) = 9
            ...
            # 4 Star
                ...
                if not pp.flag_4star:
                    ...
                    if random.randint(1, 2) == 1:
                        ...
                        b = random.choice(lstbn.albedo_rerun_banner_4)
                        # Adding to Inventory
            ...
            # 5 Star
                ...
                if not pp.flag_5star:
                    ...
                    if random.randint(1, 2) == 1:
                        # Promotional Character won
                        a = random.choice(lstbn.albedo_rerun_banner_5)
                        # Adding to Inventory
